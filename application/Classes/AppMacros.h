...
static Resource smallRetinaResource  =  { cocos2d::CCSizeMake(640, 960),   "iphonehd" };
...
#define TITLE_FONT_SIZE  (cocos2d::CCEGLView::sharedOpenGLView()->getDesignResolutionSize().width / smallRetinaResource.size.width * 24)
#define RESOLUTION_POSITION CCPointMake((CCDirector::sharedDirector()->getVisibleSize().width - designResolutionSize.width) / 2, (CCDirector::sharedDirector()->getVisibleSize().height - designResolutionSize.height) / 2)
